...
class ForwardTradingBroker(Broker):
    ...
    def close_expired_positions(self, current_date, actual_spot_price):
        ...
        for pos in self.positions:
            ...
            self.log_transaction(current_date, "CLOSE_;FORWARD", 1, pos.forward_price, payoff)
            break
    ...
    def run_backtest(self, data: pd.DataFrame):
        ...
        for _, row in data.iterrows():
            ...
            self.trade_forward(current_date, forward_price, maturity_date, predicted_spot, actual_spot)
